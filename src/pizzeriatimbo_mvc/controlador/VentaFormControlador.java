 ...
 * @author davidchenlo
 */
public class VentaFormControlador {
//    
//    private final VentaProductoFormModelo modelo;
//    private final VentaProductoFormVista vista;
//
//    public VentaFormControlador(VentaProductoFormModelo modelo, VentaProductoFormVista vista) {
//        this.modelo = modelo;
//        this.vista = vista;
...
//        @Override
//        public void actionPerformed(ActionEvent ae) {
//            final String sql = "insert into venta_producto(id_empleado,cantidad_producto,id_producto,id_tamaño) values(?,?,?,?)";
//            try {
//                modelo.getMySQL1().connect();
...
//                modelo.getMySQL1().getPreparedStatement().setInt(2, (int) vista.getSpinnerCantidadProductoIngresar().getValue());
...
//            int id_venta_producto, id_empleado, id_tamaño, id_producto, cantidad_producto;
//            final String sql1 = "select id_empleado,nombre_completo_empleado from empleado where valid=?";
//            final String sql2 = "select id_producto,nombre_producto from producto where valid=?";
//            final String sql3 = "select id_tamaño,nombre_tamaño from tamaño where valid=?";
...
//                    vista.getTableModelLeer().addRow(new Object[]{id_venta_producto, nombre_completo_empleado, cantidad_producto, nombre_producto, nombre_tamaño,last_update.toLocalDateTime()});
//                }
...
//                    final String sql = "update venta_producto set id_empleado=?,cantidad_producto=?,id_producto=?,id_tamaño=? where id_venta_producto=? and valid=?";
//                    try {
//                        modelo.getMySQL1().connect();
//                        modelo.getMySQL1().setPreparedStatement(modelo.getMySQL1().getConnection().prepareStatement(sql));
...
//                        modelo.getMySQL1().getPreparedStatement().setInt(2, (int) vista.getTableModelLeer().getValueAt(rowIndexToModel, 2));
//                        modelo.getMySQL1().getPreparedStatement().setInt(3, id_producto);
//                        modelo.getMySQL1().getPreparedStatement().setInt(4, id_tamaño);
//                        modelo.getMySQL1().getPreparedStatement().setInt(5, id_venta_producto);

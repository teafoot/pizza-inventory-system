 ...
 * @author davidchenlo
 */
public class TipoEmpleadoFormVista extends JInternalFrame {

    private JTable tableLeer;
    private DefaultTableModel tableModelLeer;
    private TableRowSorter tableRowSorterLeer;
    private TableCellEditor tableCellEditorSalario;
    private TableCellRenderer tableCellRendererSalario;
    private JLabel lblNombreIngresar;
    private JLabel lblSalarioIngresar;
    private JLabel lblHorarioIngresar;
    private JLabel lblDescripcionIngresar;
    private JLabel lblBusquedaLeer;
    private JTextField txtNombreIngresar;
    private JSpinner spinnerSalarioIngresar;
    private JSpinner spinnerSalarioLeer;
    private JTextField txtHorarioIngresar;
    ...
    private void initPanelIngresar() {
        ...
        this.setLblSalarioIngresar(new JLabel());
        this.setLblHorarioIngresar(new JLabel());
        this.setLblDescripcionIngresar(new JLabel());
        this.setTxtNombreIngresar(new JTextField());
        this.setSpinnerSalarioIngresar(new JSpinner(new SpinnerNumberModel(0, 0, 2147483647, 1)));
        this.setTxtHorarioIngresar(new JTextField());
        ...
        this.getLblSalarioIngresar().setText("Salario: ");
        this.getLblHorarioIngresar().setText("Horario: ");
        ...
        innerPanel2.add(this.getLblSalarioIngresar());
        innerPanel2.add(this.getSpinnerSalarioIngresar());
        innerPanel2.add(this.getLblHorarioIngresar());
        innerPanel2.add(this.getTxtHorarioIngresar());
    ...
    private void initPanelLeer() {
        ...
        this.setSpinnerSalarioLeer(new JSpinner(new SpinnerNumberModel(0, 0, 2147483647, 1)));
        ...
        this.setTableLeer(new JTable(this.getTableModelLeer()) {
            ...
            public TableCellRenderer getCellRenderer(int row, int column) {
                ...
                switch (modelColumn) {
                    case 2:
                        return getTableCellRendererSalario();
                    default:
            ...
            public TableCellEditor getCellEditor(int row, int column) {
                ...
                switch (modelColumn) {
                    case 2:
                        return getTableCellEditorSalario();
                    default:
    ...
    public void spinnerSalarioLeerSetTableCellEditor(TableCellEditor tableCellEditor) {
        this.setTableCellEditorSalario(tableCellEditor);
    }
    
    public void spinnerSalarioLeerSetTableCellRenderer(TableCellRenderer tableCellRenderer) {
        this.setTableCellRendererSalario(tableCellRenderer);
    }
    ...
    /**
     * @return the lblSalarioIngresar
     */
    public JLabel getLblSalarioIngresar() {
        return lblSalarioIngresar;
    }

    /**
     * @param lblSalarioIngresar the lblSalarioIngresar to set
     */
    public void setLblSalarioIngresar(JLabel lblSalarioIngresar) {
        this.lblSalarioIngresar = lblSalarioIngresar;
    }

    /**
     * @return the lblHorarioIngresar
     */
    public JLabel getLblHorarioIngresar() {
        return lblHorarioIngresar;
    }

    /**
     * @param lblHorarioIngresar the lblHorarioIngresar to set
     */
    public void setLblHorarioIngresar(JLabel lblHorarioIngresar) {
        this.lblHorarioIngresar = lblHorarioIngresar;
    }

    /**
     * @return the spinnerSalarioIngresar
     */
    public JSpinner getSpinnerSalarioIngresar() {
        return spinnerSalarioIngresar;
    }

    /**
     * @param spinnerSalarioIngresar the spinnerSalarioIngresar to set
     */
    public void setSpinnerSalarioIngresar(JSpinner spinnerSalarioIngresar) {
        this.spinnerSalarioIngresar = spinnerSalarioIngresar;
    }

    /**
     * @return the txtHorarioIngresar
     */
    public JTextField getTxtHorarioIngresar() {
        return txtHorarioIngresar;
    }

    /**
     * @param txtHorarioIngresar the txtHorarioIngresar to set
     */
    public void setTxtHorarioIngresar(JTextField txtHorarioIngresar) {
        this.txtHorarioIngresar = txtHorarioIngresar;
    }

    /**
     * @return the tableCellRendererSalario
     */
    public TableCellRenderer getTableCellRendererSalario() {
        return tableCellRendererSalario;
    }

    /**
     * @param tableCellRendererSalario the tableCellRendererSalario to set
     */
    public void setTableCellRendererSalario(TableCellRenderer tableCellRendererSalario) {
        this.tableCellRendererSalario = tableCellRendererSalario;
    }

    /**
     * @return the spinnerSalarioLeer
     */
    public JSpinner getSpinnerSalarioLeer() {
        return spinnerSalarioLeer;
    }

    /**
     * @param spinnerSalarioLeer the spinnerSalarioLeer to set
     */
    public void setSpinnerSalarioLeer(JSpinner spinnerSalarioLeer) {
        this.spinnerSalarioLeer = spinnerSalarioLeer;
    }

    /**
     * @return the tableCellEditorSalario
     */
    public TableCellEditor getTableCellEditorSalario() {
        return tableCellEditorSalario;
    }

    /**
     * @param tableCellEditorSalario the tableCellEditorSalario to set
     */
    public void setTableCellEditorSalario(TableCellEditor tableCellEditorSalario) {
        this.tableCellEditorSalario = tableCellEditorSalario;
    }
}

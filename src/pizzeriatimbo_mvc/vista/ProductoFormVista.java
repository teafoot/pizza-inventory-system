 ...
 * @author davidchenlo
 */
public class ProductoFormVista extends JInternalFrame {

    private JTable tableLeer;
    private DefaultTableModel tableModelLeer;
    private TableRowSorter tableRowSorterLeer;
    private DefaultCellEditor defaultCellEditorTipoProducto;
    private TableCellRenderer tableCellRendererTipoProducto;
    private JLabel lblNombreIngresar;
    private JLabel lblTipoProductoIngresar;
    private JLabel lblDescripcionIngresar;
    private JLabel lblBusquedaLeer;
    private JTextField txtNombreIngresar;
    private JComboBox cbxTipoProductoIngresar;
    private JComboBox cbxTipoProductoLeer;
    ...
    private void initPanelIngresar() {
        ...
        this.setLblTipoProductoIngresar(new JLabel());
        this.setLblDescripcionIngresar(new JLabel());
        this.setTxtNombreIngresar(new JTextField());
        this.setCbxTipoProductoIngresar(new JComboBox());
        ...
        this.getLblTipoProductoIngresar().setText("Tipo Producto: ");
        this.getLblDescripcionIngresar().setText("Descripcion: ");
        this.getBtnRefreshIngresar().setText("Refrescar");
        ...
        innerPanel2.add(this.getLblTipoProductoIngresar());
        innerPanel2.add(this.getCbxTipoProductoIngresar());
    ...
    private void initPanelLeer() {
        ...
        this.setCbxTipoProductoLeer(new JComboBox());
        ...
        this.setTableLeer(new JTable(this.getTableModelLeer()) {
            ...
            public TableCellEditor getCellEditor(int row, int column) {
                ...
                switch (modelColumn) {
                    case 2:
                        return getDefaultCellEditorTipoProducto();
                    default:
            ...
            public TableCellRenderer getCellRenderer(int row, int column) {
                ...
                switch (modelColumn) {
                    case 2:
                        return getTableCellRendererTipoProducto();
                    default:
    ...
    public void cbxTipoProductoLeerSetDefaultCellEditor(JComboBox cbx) {
        this.setDefaultCellEditorTipoProducto(new DefaultCellEditor(cbx) {
            @Override
            public Component getTableCellEditorComponent(JTable jtable, Object value, boolean bln, int i, int i1) {
                super.getTableCellEditorComponent(jtable, value, isSelected, i, i1);
    ...
    public void cbxTipoProductoLeerSetTableCellRenderer(TableCellRenderer tableCellRenderer) {
        this.setTableCellRendererTipoProducto(tableCellRenderer);
    }
     ...
     */
    public void setBtnModificarLeer(JButton btnModificar) {
     ...
     */
    public void setBtnEliminarLeer(JButton btnEliminar) {
    ...
    /**
     * @return the defaultCellEditorTipoProducto
     */
    public DefaultCellEditor getDefaultCellEditorTipoProducto() {
        return defaultCellEditorTipoProducto;
    }

    /**
     * @param defaultCellEditorTipoProducto the defaultCellEditorTipoProducto to
     * set
     */
    public void setDefaultCellEditorTipoProducto(DefaultCellEditor defaultCellEditorTipoProducto) {
        this.defaultCellEditorTipoProducto = defaultCellEditorTipoProducto;
    }

    /**
     * @return the tableCellRendererTipoProducto
     */
    public TableCellRenderer getTableCellRendererTipoProducto() {
        return tableCellRendererTipoProducto;
    }

    /**
     * @param tableCellRendererTipoProducto the tableCellRendererTipoProducto to
     * set
     */
    public void setTableCellRendererTipoProducto(TableCellRenderer tableCellRendererTipoProducto) {
        this.tableCellRendererTipoProducto = tableCellRendererTipoProducto;
    }

    /**
     * @return the cbxTipoProductoIngresar
     */
    public JComboBox getCbxTipoProductoIngresar() {
        return cbxTipoProductoIngresar;
    }

    /**
     * @param cbxTipoProductoIngresar the cbxTipoProductoIngresar to set
     */
    public void setCbxTipoProductoIngresar(JComboBox cbxTipoProductoIngresar) {
        this.cbxTipoProductoIngresar = cbxTipoProductoIngresar;
    }

    /**
     * @return the cbxTipoProductoLeer
     */
    public JComboBox getCbxTipoProductoLeer() {
        return cbxTipoProductoLeer;
    }

    /**
     * @param cbxTipoProductoLeer the cbxTipoProductoLeer to set
     */
    public void setCbxTipoProductoLeer(JComboBox cbxTipoProductoLeer) {
        this.cbxTipoProductoLeer = cbxTipoProductoLeer;
    }
    ...
    /**
     * @return the lblTipoProductoIngresar
     */
    public JLabel getLblTipoProductoIngresar() {
        return lblTipoProductoIngresar;
    }

    /**
     * @param lblTipoProductoIngresar the lblTipoProductoIngresar to set
     */
    public void setLblTipoProductoIngresar(JLabel lblTipoProductoIngresar) {
        this.lblTipoProductoIngresar = lblTipoProductoIngresar;
    }
}
